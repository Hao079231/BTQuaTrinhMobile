        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                switch (index){
                    ...
                    case 1: binding.fabAction.setImageDrawable(getDrawable(R.drawable.ic_launcher_background));break;
                    case 2: binding.fabAction.setImageDrawable(getDrawable(R.drawable.ic_launcher_background));break;
                }
